...
A questo punto, una volta che per ogni vicino ho i suoi parametri di lamport, i casi
	   possibili sono 2:
\begin{enumerate}
	\item \textbf{tutti i nodi hanno medesimo lamport:} setto il mio lamport al lamport
	   comune;
	\item \textbf{esiste un lamport massimo:} setto il mio lamport al valore massimo,
...
\end{enumerate}
L'esecuzione dei messaggi sarà affrontata separatamente.

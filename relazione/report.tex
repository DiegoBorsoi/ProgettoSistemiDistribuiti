...
%    \begin{verbatim}
%[bad, gen].            %$\displaystyle \leftarrow$ tipi dei nodi possibili nel grafo
%[
%  {a, gen, []},      %$\leftarrow$ identificativo del nodo, tipo, vicini
%  {b, gen, [a]},
%  {c, gen, [a, b]},
%  {d, bad, [a, b, c]}
%].
...
mostriamo i vari test descrivendoli

controlliamo che siano validi secondi trasparenze (con qualche listato? del terminale)
